...
#include "ns3/virtual-springs-qos-2d-mobility-model.h"
...
main (int argc, char* argv[]){
  ...
  *****************************/
  ...
  //LogComponentEnable ("VirtualSprings2dQos", LOG_LEVEL_DEBUG);
  ...
  ************************/
  ...
  mobility.SetMobilityModel ("ns3::VirtualSpringsQos2dMobilityModel", 
  																	"Time", TimeValue(Seconds(1)),
  																	"Tolerance", DoubleValue(1),
                                    "BsPosition", VectorValue(bsPos),
                                    "TxRangeAta", DoubleValue(500),
                                    "lbReqAta", DoubleValue (20),
                                    "lbReqAtg", DoubleValue (50));
  ...
  {
    Ptr<Node> node = *j;
    Ptr<VirtualSpringsQos2dMobilityModel> model = node -> GetObject<VirtualSpringsQos2dMobilityModel>();
